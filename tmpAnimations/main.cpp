...
//                node->setScale(irr::core::vector3df(3, 3, 3));
	}
	...
	irr::scene::IAnimatedMeshSceneNode *bomb(smgr->addAnimatedMeshSceneNode(smgr->getMesh("media/Bomb.dae"), nullptr, 0, irr::core::vector3df(-100, 0, 0), irr::core::vector3df(0, 0, 0), irr::core::vector3df(5, 5, 5)));
	bomb->setMaterialTexture(0, driver->getTexture("media/Bomb.png"));
