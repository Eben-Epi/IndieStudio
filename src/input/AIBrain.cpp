...
Input::AIBrain::AIBrain(ECS::Entity &entity, ECS::BombDropperComponent &bombDropper, ECS::ECSCore &core) :
    _bombDropper(bombDropper),
    _entity(entity),
    _core(core),
    _pos(reinterpret_cast<ECS::PositionComponent &>(this->_entity.getComponentByName("PositionComponent")))
{
...
{
    std::vector<ECS::Entity *> players = this->_core.getEntitiesByComponent("Controllable");
    static ECS::Entity *chase;
